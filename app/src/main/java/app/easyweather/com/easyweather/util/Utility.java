...
public class Utility {
    ...
    public synchronized static boolean handleProvincesResponse(
           EasyWeatherDB easyWeatherDB, String response) {
     ...
     * 解析和处理服务器返回的市级数据
     */
    public static boolean handleCitiesResponse(EasyWeatherDB easyWeatherDB,
     ...
     * 解析和处理服务器返回的县级数据
     */
    public static boolean handleCountiesResponse(EasyWeatherDB easyWeatherDB,
